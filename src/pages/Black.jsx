...
const ACCESS_KEY = "XhKRXnMMinVlaT9PXLZYNLbnLyNl53dP27f13v2gK7A";
  ...
  const fetchImages = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.unsplash.com/search/photos?query=black_and_white&order_by=latest&per_page=12&page=${page}&client_id=${ACCESS_KEY}`
      );
