...
const ACCESS_KEY = "en0lQ1L42UqBOMTupv401rSSf8WQb7MsZ-ZZG9j42Ro";
  ...
  const fetchImages = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.unsplash.com/search/photos?query=random_cars&order_by=latest&per_page=12&page=${page}&client_id=${ACCESS_KEY}`
      );
