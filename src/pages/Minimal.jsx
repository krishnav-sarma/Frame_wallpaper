...
const ACCESS_KEY = "TKJTKXxssS7Cax4R86t4cW7zkYpbDrWgO7UldhrUzC4";
  ...
  const fetchImages = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.unsplash.com/search/photos?query=dark_minimal&order_by=latest&per_page=12&page=${page}&client_id=${ACCESS_KEY}`
      );
